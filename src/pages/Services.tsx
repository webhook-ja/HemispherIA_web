      ...
      <section className="pt-24 pb-16 bg-gradient-to-r from-blue-900 to-indigo-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            >
              Transformamos desafíos complejos en oportunidades de impacto sostenible a través de tecnología, conocimiento y colaboración.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Soluciones integrales diseñadas para maximizar el impacto social y tecnológico
            </p>
          </div>
                ...
                {services[activeService].items.map((item, index) => (
                  ...
                  >
                    <div className="flex items-start">
                      <div className={`w-10 h-10 rounded-lg bg-gradient-to-r ${services[activeService].color} flex items-center justify-center text-white mr-4 flex-shrink-0`}>
                        {index + 1}
                      </div>
                      ...
                      <div key={index}>
                        ...
                        <div className="w-full bg-gray-200 rounded-full h-2">
                          <motion.div
                            ...
                            initial={{ width: 0 }}
                            animate={{ width: `${Math.min(100, parseInt(stat.value))}%` }}
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      <div key={index} className="flex items-center">
                        <div className={`w-8 h-8 rounded-full bg-gradient-to-r ${services[activeService].color} flex items-center justify-center text-white text-sm font-bold mr-3`}>
                          {index + 1}
                        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative">
              {[
                { title: "Descubrimiento", icon: <Shield className="h-6 w-6" />, description: "Entendemos tus desafíos y objetivos" },
                { title: "Estrategia", icon: <Brain className="h-6 w-6" />, description: "Diseñamos soluciones personalizadas" },
                { title: "Implementación", icon: <Zap className="h-6 w-6" />, description: "Ejecutamos con metodología ágil" },
                { title: "Impacto", icon: <BarChart3 className="h-6 w-6" />, description: "Medimos y optimizamos resultados" }
              ].map((step, index) => (
                <motion.div
                  key={index}
