  ...
  const projects = [
    {
      ...
      startDate: "Ene 2023",
      endDate: "Dic 2023",
      partners: ["MinSalud Colombia", "UNICEF", "Fundación Tecnología para Todos"],
      image: "health",
      tags: ["Salud", "IA", "Rural"]
    },
    {
      ...
      startDate: "Mar 2023",
      endDate: "Sep 2023",
      partners: ["Greenpeace", "Juventud por el Clima", "ONG Ambiental Brasil"],
      image: "climate",
    ...
    },
    {
      ...
      startDate: "Feb 2023",
      endDate: "Nov 2023",
      partners: ["Banco Central", "Comunidades Ashuar", "ONG Desarrollo Sostenible"],
      image: "finance",
      ...
      <section className="pt-24 pb-16 bg-gradient-to-r from-blue-900 to-indigo-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            >
              Resultados tangibles en toda la región a través de innovación responsable
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
                    ...
                    <div>
                      ...
                      <div className="space-y-4 mb-6">
                        <div className="flex items-center">
                          ...
                          <span className="text-gray-700">{projects[selectedProject].location}</span>
                        </div>
                        
                        <div className="flex items-center">
                          <Calendar className="mr-2 h-5 w-5 text-gray-500" />
                          <span className="text-gray-700">
                            {projects[selectedProject].startDate} - {projects[selectedProject].endDate}
                          </span>
                        </div>
                        
                        <div className="flex items-center">
                          <TrendingUp className="mr-2 h-5 w-5 text-gray-500" />
                          <span className="text-gray-700 font-semibold">{projects[selectedProject].impact}</span>
                        </div>
                      ...
                      <div className="mb-6">
                        <h4 className="font-semibold text-gray-900 mb-2">Aliados Estratégicos</h4>
                        <ul className="space-y-2">
                          {projects[selectedProject].partners.map((partner, index) => (
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Impacto Regional</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Nuestros proyectos han generado resultados medibles en toda América Latina y el Caribe
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            {[
              { value: "25+", label: "Países Alcanzados", description: "Presencia en toda la región latinoamericana" },
              { value: "150K+", label: "Personas Impactadas", description: "Beneficiarios directos e indirectos" },
              { value: "42", label: "Proyectos Completados", description: "Soluciones implementadas con éxito" }
            ].map((stat, index) => (
              <motion.div
                key={index}
          ...
          <div className="bg-gray-100 rounded-2xl p-8">
            <h3 className="text-2xl font-bold text-center text-gray-900 mb-8">Distribución Geográfica</h3>
            <div className="bg-white border-2 border-dashed border-gray-300 rounded-xl w-full h-96 flex items-center justify-center">
              <p className="text-gray-500">Mapa interactivo de proyectos en Latinoamérica</p>
            </div>
          </div>
        </div>
      </section>
